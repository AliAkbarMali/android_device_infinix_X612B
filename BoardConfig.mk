...
DEVICE_PATH := device/infinix/Infinix-X612B
...
# Assert
TARGET_OTA_ASSERT_DEVICE := Infinix-X612B
...
TARGET_KERNEL_SOURCE := kernel/infinix/Infinix-X612B
TARGET_KERNEL_CONFIG := Infinix-X612B_defconfig
